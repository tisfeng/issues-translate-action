...
const plugin_rest_endpoint_methods_1 = __webpack_require__(256);
const plugin_paginate_rest_1 = __webpack_require__(125);
...
const got = __webpack_require__(417);
...
const franc_min_1 = __importDefault(__webpack_require__(554));
...
function getTranslationContext(context) {
    var _a, _b, _c, _d;
    ...
    if (context.eventName === ISSUE_COMMENT_EVENT) {
        ...
        return {
            ...
            commentTarget: {
                kind: 'issue',
                issueNumber: issue.number,
                htmlUrl: (_a = comment.html_url) !== null && _a !== void 0 ? _a : issue.html_url
            }
        };
    }
    if (context.eventName === REVIEW_COMMENT_EVENT) {
        ...
        return {
            ...
            commentTarget: {
                ...
                htmlUrl: (_b = comment.html_url) !== null && _b !== void 0 ? _b : pullRequest.html_url
            }
        };
    }
    if (context.eventName === ISSUES_EVENT) {
        ...
        return {
            ...
            originComment: (_c = issue.body) !== null && _c !== void 0 ? _c : null,
            originTitle: (_d = issue.title) !== null && _d !== void 0 ? _d : null,
            commentTarget: {
                kind: 'issue',
                issueNumber: issue.number,
...
exports.getTranslationContext = getTranslationContext;
function buildTranslateBody(translateComment, translateTitle, needCommitComment, needCommitTitle, isModifyTitle, botNote) {
...
${translateComment !== null && translateComment !== void 0 ? translateComment : ''}  
      `;
    }
    return ` 
> ${botNote}         
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            if (!shouldHandleEvent(github.context.eventName, github.context.payload.action)) {
                core.info(`The action only supports issue_comment(created), issues(opened), and pull_request_review_comment(created); received ${github.context.eventName}(${github.context.payload.action}), return`);
                return;
            }
            ...
            if (needCommitComment && needCommitTitle) {
                ...
                translateOrigin = originComment !== null && originComment !== void 0 ? originComment : '';
            }
            else {
...
function detectIsEnglish(body) {
    ...
    const detectResult = franc_min_1.default(body);
    if (detectResult === 'und' ||
...
function translateIssueOrigin(body) {
    return __awaiter(this, void 0, void 0, function* () {
        let result = '';
        try {
            const response = yield google_translate_api_1.default(body, { to: 'en' });
...
function createComment(commentTarget, body, octokit) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        const { owner, repo } = github.context.repo;
        if (commentTarget.kind === 'pull_request_review_comment') {
            yield octokit.request('POST /repos/{owner}/{repo}/pulls/{pull_number}/comments/{comment_id}/replies', {
                owner,
                repo,
            ...
            core.info(`complete to push translate review comment: ${body} in ${(_a = commentTarget.htmlUrl) !== null && _a !== void 0 ? _a : ''} `);
            return;
        }
        ...
        core.info(`complete to push translate issue comment: ${body} in ${(_b = commentTarget.htmlUrl) !== null && _b !== void 0 ? _b : ''} `);
    });
}
function modifyTitle(issueNumber, title, octokit) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const { owner, repo } = github.context.repo;
        const issueUrl = (_b = (_a = github.context.payload.issue) === null || _a === void 0 ? void 0 : _a.html_url) !== null && _b !== void 0 ? _b : '';
...
var trigram = __webpack_require__(286).trigram
...
const httpClient = __importStar(__webpack_require__(291));
